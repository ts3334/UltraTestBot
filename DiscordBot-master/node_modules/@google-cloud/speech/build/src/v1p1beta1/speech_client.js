...
class SpeechClient {
    ...
    constructor(opts) {
        ...
        this._descriptors.longrunning = {
            longRunningRecognize: new gaxModule.LongrunningDescriptor(operationsClient, longRunningRecognizeResponse.decode.bind(longRunningRecognizeResponse), longRunningRecognizeMetadata.decode.bind(longRunningRecognizeMetadata)),
        };
        ...
        this._speechStub = gaxGrpc.createStub(opts.fallback
        ...
        for (const methodName of speechStubMethods) {
            const innerCallPromise = this._speechStub.then(stub => (...args) => {
